...
class App_View_Helper_FlashMessagesSimple extends Zend_View_Helper_Abstract
{
	 ...
	 */
	public function flashMessagesSimple()
	{
		...
		if (count($messages) > 0) {
			...
			return '<div class="loginErrorsWrapper"><div class="loginErrors"><div class="wrap1"><div class="wrap2">'
				. $output
				. '</div></div></div></div>';
		}
